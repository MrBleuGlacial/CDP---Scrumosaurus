      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
         <!-- <ul class="nav navbar-nav navbar-right">
          ...
          <button type="button" class="btn btn-sm btn-default navbar-btn navbar-right" style="margin-right: 3px;">S'enregistrer</button>
          <button type="button" class="btn btn-sm btn-primary navbar-btn navbar-right" style="margin-right: 10px;">Se connecter</button>
        </div>
      </div>
    </nav>
